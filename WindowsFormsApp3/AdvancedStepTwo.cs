...
{
    public partial class AdvancedStepTwo : Form
    {
        public AdvancedStepTwo()
        {
            InitializeComponent();
            LayoutSetup();
        }
        ...
        private void LayoutSetup()
        {
            ...
            lblNorthSouth.Left = (int)(panelMain.Width * 0.5f - lblNorthSouth.Width * 0.5f);
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            if (complete)
            {
                AdvancedCalculation.NorthSouthTotal = windowTotal + doorTotal + wallTotal;
                AdvancedCalculation.NorthSouthTotalArea = winArea + doorArea;
                AdvancedCalculation.NSWinArea = winArea;
                AdvancedCalculation.NSDoorArea = doorArea;
                AdvancedCalculation.NSWallArea = wallArea;
        ...
        public void WindowData()
        {
            ...
            try
            {
                winArea = double.Parse(txtNorthSouthWindow.Text);
            }
            catch (Exception)
            {
                complete = false;
            ...
            if (cboNorthSouthWindow.SelectedIndex < 0)
            {
                complete = false;
            ...
            {
                AdvancedCalculation.NSwinConstType = cboNorthSouthWindow.Text;
            }
        ...
        public void DoorData()
        {
            ...
            try
            {
                doorArea = double.Parse(txtNorthSouthDoor.Text);
            }
            catch (Exception)
            {
                complete = false;
            ...
            // Check construction type, if unsuccessful set completion tracker to false and display error image else assign value
            if (cboNorthSouthDoor.SelectedIndex < 0)
            {
                complete = false;
            ...
            {
                AdvancedCalculation.NSDoorConstType = cboNorthSouthDoor.Text;
            }
            ...
            else if (cboNorthSouthDoor.SelectedIndex == 1)
            {
                doorTotal = doorArea * 11.0;
            }
            else if (cboNorthSouthDoor.SelectedIndex == 2)
            {
                doorTotal = doorArea * 3.5;
            }
            else if (cboNorthSouthDoor.SelectedIndex == 3)
            {
        ...
        public void WallData()
        {
            ...
            try
            {
                wallArea = double.Parse(txtNorthSouthWall.Text);
            }
            catch (Exception)
            {
                complete = false;
            ...
            // Check construction type, if unsuccessful set completion tracker to false and display error image else assign value
            if (cboNSWallFrame.SelectedIndex < 0)
            {
                complete = false;
            ...
            {
                AdvancedCalculation.NSWallSidingType = cboNSWallSiding.Text;
            }
            ...
            if (complete)
            {
                ...
                wallTotal = wallArea * wallModifiers[cboNSWallFrame.SelectedIndex, cboNSWallInsulation.SelectedIndex,
                    cboNSWallSiding.SelectedIndex];
            }
        }
